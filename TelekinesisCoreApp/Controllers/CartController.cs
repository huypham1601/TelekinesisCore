...
using TelekinesisCoreApp.Models;
...
using TelekinesisCoreApp.Services;
...
namespace TelekinesisCoreApp.Controllers
{
    public class CartController : Controller
    {
        ...
        private void PayPal()
        {
            string _MerchantEmail = " huyppngcs15200-buyer@fpt.edu.vn";
            ...
            int _Discount = 10;
            double _Tax = 1.5;
            string _PayPalURL = $"https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_xclick&business={_MerchantEmail}&return={_ReturnURL}&cancel_return={_CancelURL}&currency_code={_CurrencyCode}&amount={_Amount}&item_name={_ItemName}&discount_amount={_Discount}&tax={_Tax}";
